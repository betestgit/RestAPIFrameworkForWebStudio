...
public class RejectArtifactsTest extends BaseClass {
	...
	@Test(priority = 1, description = "Create DT, Commit and reject it")
	public void testRejectDT() throws FileNotFoundException {

		ExtentTestManager.getTest().setDescription("Create DT, Commit and reject it");
		ExtentTestManager.getTest().assignCategory("RejectArtifactsTest");
		...
		Assert.assertEquals(Utilities.rawToJson(resp).getInt("response.status"), 0);
		ExtentTestManager.getTest().log(LogStatus.INFO, "Rejected DT successfully");

	}

	@Test(priority = 2)
	public void testRejectBuilderRTI() throws FileNotFoundException {
		ExtentTestManager.getTest().setDescription("Create builder RTI, Commit and reject it");
		...
		Assert.assertEquals(Utilities.rawToJson(resp).getInt("response.status"), 0);
		ExtentTestManager.getTest().log(LogStatus.INFO, "Rejected builder type RTI successfully");

	}

	@Test(priority = 3)
	public void testRejectViewRTI() throws FileNotFoundException {

		ExtentTestManager.getTest().setDescription("Create view RTI, Commit and reject it");
		...
		Assert.assertEquals(Utilities.rawToJson(resp).getInt("response.status"), 0);
		ExtentTestManager.getTest().log(LogStatus.INFO, "Rejected view based RTI successfully");
	}
